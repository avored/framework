...
return [
    ...
    'graphql' => [
        ...
        'schemas' => [
            ...
            'admin' => [
                'query' => [
                    'AllCategories' => \AvoRed\Framework\Graphql\Queries\Admin\Catalog\Category\AllCategories::class,
        ...
        'types' => [
            // 'attribute' => AvoRed\Framework\Graphql\Types\AttributeType::class,
            ...
            'option' => AvoRed\Framework\Graphql\Types\OptionType::class,
