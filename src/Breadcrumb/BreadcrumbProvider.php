    ...
    protected function registerBreadcrumb()
    {
        BreadcrumbFacade::make(
            ...
            function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('avored-framework::breadcrumb.dashboard');
            }
        );
        ...
        BreadcrumbFacade::make(
            'admin.product.edit', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Edit')
                    ->parent('admin.dashboard')
                    ->parent('admin.product.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.product.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Show')
                    ->parent('admin.dashboard')
                    ->parent('admin.product.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.order.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.order.view', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.order-status.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.order-status.create', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
        ...
        BreadcrumbFacade::make(
            'admin.order-status.edit', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Edit')
                    ->parent('admin.dashboard')
                    ->parent('admin.order-status.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.order-status.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Show')
                    ->parent('admin.dashboard')
                    ->parent('admin.order-status.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.attribute.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.attribute.create', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
        ...
        BreadcrumbFacade::make(
            'admin.attribute.edit', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Edit')
                    ->parent('admin.dashboard')
                    ->parent('admin.attribute.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.attribute.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Show')
                    ->parent('admin.dashboard')
                    ->parent('admin.attribute.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.property.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.property.create', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
        ...
        BreadcrumbFacade::make(
            'admin.property.edit', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Edit')
                    ->parent('admin.dashboard')
                    ->parent('admin.property.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.property.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
                    ->parent('admin.property.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.user.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.user.create', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
        ...
        BreadcrumbFacade::make(
            'admin.user.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Show')
                    ->parent('admin.dashboard')
                    ->parent('admin.user.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.user-group.index', function (Breadcrumb $breadcrumb) {
        ...
        BreadcrumbFacade::make(
            'admin.user-group.create', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Create')
                    ->parent('admin.dashboard')
        ...
        BreadcrumbFacade::make(
            'admin.user-group.edit', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Edit')
                    ->parent('admin.dashboard')
                    ->parent('admin.user-group.index');
            }
        ...
        BreadcrumbFacade::make(
            'admin.user-group.show', function (Breadcrumb $breadcrumb) {
                $breadcrumb->label('Show')
                    ->parent('admin.dashboard')
                    ->parent('admin.user-group.index');
            }
