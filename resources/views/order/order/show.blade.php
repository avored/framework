...
@section('meta_title')
    {{ __('avored::system.show') }} {{ __('avored::system.terms.order') }}: AvoRed E commerce Admin Dashboard
@endsection

@section('page_title')
    <div class="text-gray-800 flex items-center">
        <div class="text-xl px-5 text-red-700 font-semibold">
            {{ __('avored::system.show') }} {{ __('avored::system.terms.order') }}
        </div>
    </div>
@endsection
@section('content')
<order-show inline-template>
<div class="block">
    <div class="flex">
        <div class="w-1/2">
        ...
        <div class="w-1/2 ml-5">
            ...
            </div>  <!-- ORDER PRODUCT TABLE CARD CLOSE -->
            ...
            <div class="border mt-5 rounded">
                ...
                <div class="p-5">
                    ...
                    @endforeach
                    <form method="post" action="{{ route('admin.order-comment.store', ['order' => $order->id]) }}">
                        @csrf
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            <avored-toggle
                                label-text="{{ __('avored::system.is_private') }}"
