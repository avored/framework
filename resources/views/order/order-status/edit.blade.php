    ...
    <div>
        <div class="p-5">
            ...
            <div class="mt-5 w-full">
                <x-avored::form.form action="{{ route('admin.order-status.update', $orderStatus) }}" method="PUT">
                    @foreach ($tabs as $tab)
                    ...
                    <div class="mt-6 flex">
                        ...
                        <x-avored::link url="{{ route('admin.order-status.index') }}" class="ml-3" style="button-default">
