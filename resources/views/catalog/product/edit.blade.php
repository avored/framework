...
@section('meta_title')
    {{ __('avored::system.pages.title.edit', ['attribute' => __('avored::system.terms.product')]) }}: AvoRed E commerce Admin Dashboard
@endsection

@section('page_title')
    <div class="text-gray-800 flex items-center">
        <div class="text-xl text-red-700 font-semibold">
            {{ __('avored::system.pages.title.edit', ['attribute' => __('avored::system.terms.product')]) }}
        </div>
    </div>
@endsection
