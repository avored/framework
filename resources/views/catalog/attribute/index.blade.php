                    ...
                    <x-slot name="body">
                        @foreach ($attributes as $attribute)
                            <x-avored::table.row class="{{ ($loop->index % 2 == 0) ? '' : 'bg-gray-200'  }}">
                                ...
                                <x-avored::table.cell>
                                    <div class="flex">
                                        <x-avored::link url="{{ route('admin.attribute.edit', $attribute) }}">
                                        ...
                                        <x-avored::link
                                            x-on:click.prevent="toggleConfirmationDialog(
                                                true,
                                                {{ $attribute }},
                                                '{{ __('avored::system.confirmation_delete_message', ['attribute_value' => $attribute->name, 'attribute' => strtolower(__('avored::system.attribute'))]) }}',
