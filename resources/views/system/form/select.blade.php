<div x-data="avoredDropdownHandler('{{ $value }}', '{{ json_encode($options) }}', '{{ $name }}')"
    x-init="dropdownInit()"
    ...
    <div class="mt-1 relative">
        <button type="button" 
            ...
            class="relative w-full bg-white border border-gray-200 rounded-md shadow-sm pl-3 pr-10 py-2 text-left focus:outline-none sm:text-sm">
