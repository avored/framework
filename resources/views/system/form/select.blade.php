<div x-data="avoredDropdownHandler('{{ $value }}', '{{ json_encode($options) }}')"
  ...
  <div class="mt-1 relative">
    <button type="button" 
      ...
      <span class="flex items-center" x-html="selectedLabel">
    ...
    <div x-show="dropdownIsOpen"  class="absolute z-10 mt-1 w-full rounded-md bg-white shadow-lg">
      <ul tabindex="-1" role="listbox" 
        ...
        @foreach ($options as $optionValue => $optionLabel)
            ...
            <span class="absolute {{ $value === $optionValue ? 'text-primary' : 'hidden' }} hover:text-white inset-y-0 right-0 flex items-center pr-4">
