...
@include('avored-framework::forms.text',['name' => 'name' ,'label' => __('avored-framework::role.role-name')])

@include('avored-framework::forms.textarea',['name' => 'description' ,'label' => __('avored-framework::role.role-description')])
