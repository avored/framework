    ...
    <div>
        <div class="p-5">
            ...
            <div class="mt-5 w-full">
                <x-avored::form.form action="{{ route('admin.configuration.store') }}" method="POST">
                    ...
                    <div class="mt-6 flex">
                        ...
                        <x-avored::link url="{{ route('admin.configuration.index') }}" class="ml-3" style="button-default">
