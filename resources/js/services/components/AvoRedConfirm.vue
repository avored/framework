  ...
  <Transition name="fade">
    ...
    >
      <div class="max-h-screen w-full max-w-sm bg-white shadow-lg rounded-lg">
        <div class="overflow-auto p-5 block max-h-screen w-full">{{ confirmMessage }}</div>
        <div class="flex items-center justify-end border-t p-3">
          ...
          <button
            ...
            type="button"
            class="px-4 py-2 text-white hover:text-white bg-red-600 rounded hover:bg-red-700"
